import { a1 as commonjsGlobal, P as getDefaultExportFromCjs, r as reactExports, T as React, U as jsxRuntimeExports } from "./worker-entry-RvXzK_OZ.js";
import { c as createLucideIcon, o as clsx, s as supabase, P as Package } from "./router-EmVj5R-A.js";
import { C as Card } from "./card-WLoRe_Ec.js";
...
function AdminDashboard() {
  ...
  reactExports.useEffect(() => {
    (async () => {
      const [{
        ...
        count: uCount
      }] = await Promise.all([supabase.from("orders").select("id,total,created_at,status,order_items(product_name,quantity)"), supabase.from("products").select("*", {
        count: "exact",
        head: true
      ...
      const all = orders ?? [];
      const revenue = all.reduce((s2, o) => s2 + Number(o.total), 0);
      setStats({
        revenue,
        orders: all.length,
        products: pCount ?? 0,
      ...
      all.forEach((o) => {
        const k2 = o.created_at.slice(0, 10);
        if (k2 in days) days[k2] += Number(o.total);
      });
      setChart(Object.entries(days).map(([day, revenue2]) => ({
        day: day.slice(5),
        revenue: revenue2
      })));
      const prodMap = {};
      all.forEach((o) => (o.order_items ?? []).forEach((it) => {
        prodMap[it.product_name] = (prodMap[it.product_name] ?? 0) + it.quantity;
      }));
      setTopProducts(Object.entries(prodMap).map(([name, qty]) => ({
        name,
        qty
      })).sort((a2, b) => b.qty - a2.qty).slice(0, 5));
    })();
  }, []);
  const cards = [{
    label: "Revenue",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: cards.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: c2.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-display text-2xl font-bold", children: c2.value })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(c2.icon, { className: "h-8 w-8 text-primary opacity-80" })
    ] }) }, c2.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 font-display text-lg font-bold", children: "Revenue (last 7 days)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chart, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", opacity: 0.3 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "revenue", fill: "var(--color-primary)", radius: [6, 6, 0, 0] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 font-display text-lg font-bold", children: "Top selling products" }),
        topProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No sales yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: topProducts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center justify-between", children: [
